...
COMMENT ON COLUMN SHOP_CATEGORY.RGS_ID IS '카테고리 등록자 아이디';
...
COMMENT ON COLUMN SCOTT.SHOP_PRODUCT_IMAGE.REGT_DTM IS '등록 날짜';
...
CREATE TABLE SHOP_CODE(
	  ...
	  RGST_DTM DATE DEFAULT SYSDATE NOT NULL,
...
COMMENT ON COLUMN SHOP_CODE.RGST_DTM IS '등록일';
