...
COMMENT ON TABLE TB_PRODUCT_OPTION IS '상품 옵션별 재고 현황';

COMMENT ON COLUMN TB_PRODUCT_OPTION.PRDT_CODE IS '상품코드';

COMMENT ON COLUMN TB_PRODUCT_OPTION.PRDT_COLOR_CODE IS '상품 컬러 코드';

COMMENT ON COLUMN TB_PRODUCT_OPTION.PRDT_SIZE IS '상품 사이즈';

COMMENT ON COLUMN TB_PRODUCT_OPTION.PRDT_LAVE_COUNT IS '상품 재고 카운트';

COMMENT ON COLUMN TB_PRODUCT_OPTION.RGS_ID IS '생성자 아이디';

COMMENT ON COLUMN TB_PRODUCT_OPTION.REGT_DTM IS '생성일';

COMMENT ON COLUMN SCOTT.TB_PRODUCT_OPTION.MOD_DTM IS '수정일';

COMMENT ON COLUMN SCOTT.TB_PRODUCT_OPTION.MOD_ID IS '수정자 아이디';
