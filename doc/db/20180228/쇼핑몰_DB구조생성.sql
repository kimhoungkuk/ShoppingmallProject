...
COMMENT ON COLUMN SHOP_CATEGORY.REG_DT IS '카테고리 등록일';
...
CREATE TABLE SHOP_PRODUCT_IMAGE(
	  ...
	  PRDT_ORG_IMAGE_NAME VARCHAR2(100) NOT NULL,
	  PRDT_SAVE_IMAGE_NAME VARCHAR2(100) NOT NULL
);
...
COMMENT ON COLUMN SCOTT.SHOP_PRODUCT_IMAGE.PRDT_ORG_IMAGE_NAME IS '원본 파일명';
COMMENT ON COLUMN SCOTT.SHOP_PRODUCT_IMAGE.PRDT_SAVE_IMAGE_NAME IS '저장 파일명';
